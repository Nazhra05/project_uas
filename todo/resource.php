...
<html lang="en">
  ...
  <section class="profile" id="home" style="padding-bottom: 5cm; background-color:#0c9463">
      <div class="row pb-5">
        <div class="col-8">
          <h2 class="mt-4 ">Here Some Resource Of Productivity</h2>
          <h1 style="color: #0c9463"><i class="bi bi-check2-square"></i></h1>
          <p class="mt-2 fs-5" style="text-align: justify; padding-right: 1.5cm">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Veritatis dolor nesciunt officiis obcaecati tempora ea praesentium quas tenetur sunt earum perspiciatis a ab delectus expedita, porro aspernatur. Doloribus, fugit velit.
          </p>  
        </div>
        <div class="col-4 mt-3 text-center">
          <object data="assets/resource1.svg"></object>
        </div>
      </div>
